...
//        
//        // 2. Act
//        firebaseUser.createUser(email: email, password: password, pseudo: pseudo) { uid, error in
//            // 3. Assert
...
//        // Given
//        let expectedUser = aUser(id: "id", username: "", email: "", inscription_date: Date(), rank: 3, points: 3, invites: [:], profile_picture: "", friends: [""], friendRequests: [:])
...
//        // Arrange
//        let expectedQuizzes = [Quiz(id: "id", name: "", category_id: "", creator: "", difficulty: "", questions: [UniversalQuestion(id: "questionId", category: "category", type: "type", difficulty: "medium", question: "Question?", correct_answer: "Answer", incorrect_answers: ["Wrong"], explanation: "Explanation"): <#value#>], average_score: 0, users_completed: 0, code: "")]
